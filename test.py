...
def get_player_info(player_name):
    ...
    driver = uc.Chrome()  # Initialize the driver instance
    ...
    for table in tables:
        ...
        # Her bir tbody etiketini döngüye al
        for tbody in tbodies:

            # tbody içindeki tüm tr etiketlerini bul
            rows = tbody.find_all("tr", class_=["player_tr_1", "player_tr_2"])

            pprint.pprint(parse_player_info(soup, rows))
...
def parse_player_info(soup, html_content):
